...
To plot the corresponding DAG, which shows the relationships between target files (wheat coloured circles) which we can (re)generate from a minimal set of syntax and data files (green rectangles), use:
